-- Active: 1788699480576@@127.0.0.1@5432@postgres
...
select department, count(department) as total_ from Employees GROUP BY department;
...
select department , avg(salary) as avg_salary from Employees where department='Finance' GROUP BY department ;
