...
SELECT  FirstName,DepartmentName from employees  e join departments  d on e.DepartmentID=d.DepartmentID

--Write a SQL query to list all the departments and the employees working in them, including departments with no employees.
SELECT distinct * from employees  e join departments  d on e.DepartmentID=d.DepartmentID 
